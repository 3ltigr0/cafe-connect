...
public class CeoController {
    ...
    @PostMapping("/auth")
    public ResponseEntity<CeoAuthenticateResponse> authenticateCeo(@RequestBody @Valid CeoAuthenticateRequest ceoAuthenticateRequest) {
        CeoAuthenticateResponse ceoAuthenticateResponse =  ceoService.authenticateCeo(ceoAuthenticateRequest);
        return ResponseEntity.ok(ceoAuthenticateResponse);
    }
}
